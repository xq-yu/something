...
import os 
os.chdir('/Users/yu/Desktop/coding/github/something/AutoSql/demos/实时交易特征构建/')
...
base_feature_sql,features = autosql.base_feature_create('./config2.xlsx',['prikey'],window='win1')
